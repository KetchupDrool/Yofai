...
## Status
- Phases 1–70 technical history complete (see `DECISIONS.md`, `APP_STORE_SUBMIT_GATES.md`, `SHAWN_NEXT_RELEASE_STEPS.md`)
- **Phase 70:** collapsible Export JPEGs groups (History/Queue start collapsed); no Direct Upload; no archive
