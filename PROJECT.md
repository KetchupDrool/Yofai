...
## Status
- Phases 1–42 technical history complete (see `DECISIONS.md`)
...
- Export Readiness checklist is computed from local project/photo/export state (not persisted); watermark is optional; no compliance claims
